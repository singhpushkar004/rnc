...
<!-- about section start -->
 <div class="container-fluid">
    ...
    NON-TEACHING STAFF
      ...
      <h6 class="text-white text-center"><a href="index.php" style="color:blue;">HOME ></a> ACADEMICS</h6>
    </div>
    </div>
  <!-- principal start -->
   <div class="container">
   <div class="row mb-4">
      <div class="col-sm-12 border-center border-5 border-dark">
        ...
        font-weight: 400;"><b> Non-Teaching Staff
 </b></h1>
        <hr class="shadow">
      </div>
    </div>
                            ...
                            <th>Mobile no</th>
                                 ...
                                 <?php
                                    ...
                                    while($row=mysqli_fetch_array($res))
                                        ...
                                        <td><img src="admin/nonteacher/<?php echo $row['picname'];?>"height="100px" width="100px/>"</td>
