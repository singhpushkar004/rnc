...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    $mail->Username='kajalyadav0889@gmail.com';
    $mail->Password = 'gyaa olii ovvf ddji';
    $mail->SMTPSecure=PHPMailer::ENCRYPTION_SMTPS;
    $mail->setFrom('kajalyadav@gmail.com','KAJAL YADAV');
    $mail->addAddress($email,$name);
    $mail->Port=465;
    $mail->Subject='Registration Form For RNC Student';
    $mail->Body='Thank You '.$name.' For Registring in php mailer
    This is Php Mailer
    ';
    $mail->send();
}
